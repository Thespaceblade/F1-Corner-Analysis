            ...
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={compoundChartData}>
                ...
                <XAxis 
                  ...
                  label={{ value: 'Compound', position: 'insideBottom', offset: -5, fill: '#9aa4b2', fontSize: 12 }}
                />
                <YAxis 
                  stroke="#9aa4b2"
                  tick={{ fill: '#9aa4b2', fontSize: 12 }}
                  label={{ value: 'Avg Lap Time (s)', angle: -90, position: 'insideLeft', fill: '#9aa4b2', fontSize: 12 }}
                />
                <Tooltip 
            ...
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={tyreLifePerformanceData}>
                ...
                <XAxis 
                  ...
                  stroke="#9aa4b2"
                  tick={{ fill: '#9aa4b2', fontSize: 12 }}
                  label={{ value: 'Tyre Life (laps)', position: 'insideBottom', offset: -5, fill: '#9aa4b2', fontSize: 12 }}
                />
                <YAxis 
                  stroke="#9aa4b2"
                  tick={{ fill: '#9aa4b2', fontSize: 12 }}
